...
let userID = "659a417b-b07b-4dea-9266-0293e21d6632";

const proxyIPs = ["194.36.179.240"]; //workers.cloudflare.cyou bestproxy.onecf.eu.org cdn-all.xn--b6gac.eu.org cdn.xn--b6gac.eu.org
const cn_hostnames = [''];
